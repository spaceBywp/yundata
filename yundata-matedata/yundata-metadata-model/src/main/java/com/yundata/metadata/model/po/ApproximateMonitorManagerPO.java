...
public class ApproximateMonitorManagerPO implements Serializable {
    private String approximateId;
    ...
    public String getApproximateId() {
        return approximateId;
    }

    public void setApproximateId(String approximateId) {
        this.approximateId = approximateId == null ? null : approximateId.trim();
    }
