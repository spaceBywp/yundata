...
public class UserMcBrandMessagePO implements Serializable {
    private String mcMsgId;
    ...
    public String getMcMsgId() {
        return mcMsgId;
    }

    public void setMcMsgId(String mcMsgId) {
        this.mcMsgId = mcMsgId == null ? null : mcMsgId.trim();
    }
